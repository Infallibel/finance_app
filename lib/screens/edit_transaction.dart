                  ...
                  builder: (context, state) {
                    return IconTextAndRow(
                        selectionText: state is PaymentTypeSelected
                            ...
                            : 'Not Selected',
                        onTap: () {
                          context.read<PaymentTypeCubit>().showOptions(context);
                        },
              ...
              TextButtonModel(
                onPressed: () {
                  final updatedTransaction = transactionData.copyWith(
                    ...
                    category:
                        context.read<CategoryCubit>().state is CategorySelected
                    ...
                    transactionType: context.read<TransactionTypeCubit>().state
                            is TransactionTypeSelected
